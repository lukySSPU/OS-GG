...
from .models import Contact, ContactGroup, Gender, Vyrobce, ModelVoz
...
class VyrobceView(ModelView):
    ...
    related_views = [Vyrobce]

class ModelVoz(ModelView):
    datamodel = SQLAInterface(ModelVoz)
    related_views = [ModelVoz]
...
appbuilder.add_view(
    ModelVoz, "Model", icon="fa-dashboard", category="Contacts"
)
appbuilder.add_view(
